...
<li id="contact1" style = "display:block;"  ><a style = "color:white;" href="{{route('order')}}">{{__('ORDER NOW')}}</a></li>
 ...
 <div id = "bas" style = "margin-top: -15px;">
        ...
        <div class = "bg" style = "height:520px;">
        </div>

        <div class = "bg1" style="display:none; height:200px;">
            <h3 id = "gggg">f</h3>
        </div>
    ...
    <div class="boot" >
                        <div class="boot1" style="width: 26rem; height:24rem;" >
                            
                                <div class="textwidget">
                                    <div class="icon icon-cakes">
                                        
                                    </div>
<h2><b>{{__('Cakes')}}</b></h2>
<p id = "div1">{{__('Customized for all occasions and created by hand with the finest ingredients and artistic craftsmanship.')}}</p>
<p id = "button">{{__('Affordable prices!')}}</p>
                                </div>
                            
                        </div>
                        
                        <div  class="boot2" style="width: 26rem; height:24rem;" >
                            
                                <div class="textwidget">
                                    <div class="icon icon-cupcakes">
                                        
                                    </div>
<h2><b>{{__('Cupcakes')}}</b></h2>
<p  id = "div1">{{__('Custom flavours and designs topped with signature buttercream. Possibilities are endless for every celebration.')}}</p>
<p id = "button">{{__('Affordable prices!')}}</p>
                                </div>
                            
                        </div>
                        
                        <div  class="boot3" style="width: 26rem; height:24rem;" >
                            
                                <div class="textwidget">
                                    <div class="icon icon-cakepops">
                                        
                                    </div>
<h2><b>{{__('Cake Pops')}}</b></h2>
<p  id = "div1">{{__('Little bits of goodness dipped in chocolate or vanilla and decorated for all those special occasions.')}}</p>
<p id = "button">{{__('Affordable prices!')}}</p>
                                </div>
...
<div class="b1" style="width: 23rem; height:20rem;">
 <h1>{{__('Sweet cravings')}}</h1>

</div>

<div class="b2" style="width: 23rem; height:20rem;">
 <h1>{{__('Savoury cravings')}}</h1>

</div>

<div class="b3" style="width: 23em; height:20rem;">
 <h1>{{__('English eats')}}</h1>
