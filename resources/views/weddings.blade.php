...
<li id="contact1" style = "display:block;"  ><a style = "color:white;" href="{{route('order')}}">{{__('ORDER NOW')}}</a></li>
 ...
 <div id = "bas" style = "margin-top: -15px;">
        ...
        <div class = "bg1" style="height:200px;">
            <h3 id = "gggg">{{__('Wedding cakes')}}</h3>
        </div>

        <div id="us1">
        
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src = "https://www.brides.com/thmb/0FTZbjxJNPyYoTfxIMEIPJel1KY=/1200x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__brides__public__brides-services__production__2019__02__21__5c6ec93ad930212ccf726c97_annie-and-marc-wedding33-224981d972864fa2a595f29ac37e3d0c.jpg"  alt=" ">
          <div class="card-body">
            <h6 style = "color:black;"><del>25,000 {{__('tg')}}</del></h6>
                            <h6 style = "color:#cc7894;">19,990 {{__('tg')}}</h6>
                            <h6>{{__('Lemon Raspberry')}}</h6>
                            <h6>{{__('Strawberry Shortcake')}}</h6>
                            <h6>{{__('Tuxedo (marble)')}}</h6>
          </div>
        </div>
        
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src="https://www.brides.com/thmb/fRxFqWIzMKlq5TY7Qpqswh8ugkE=/1200x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__brides__public__brides-services__production__2018__10__30__5bd8af141d46881cabe42588_rachel-and-adam-wedding19-53027f3d0cb9464a97bde10d15e748c3.JPG" alt=" ">
          <div class="card-body">
            <h6 style = "color:black;"><del>30,000 {{__('tg')}}</del></h6>
                            <h6 style = "color:#cc7894;">24,990 {{__('tg')}}</h6>
                            <h6> {{__('Strawberry')}}</h6>
                            <h6>{{__('Oreo')}}</h6>
                            <h6>{{__('Skor')}}</h6>
          </div>
        ...
        <div class="c" style="width: 23em; height:38rem;">
          <img class="cit" src="https://www.brides.com/thmb/mq-OB-5fZ13GZrus49-mESzohkk=/1200x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__brides__public__brides-services__production__2019__02__14__5c65b3d8274f772e0f38baf9_ESPECIALLY20AMY-1ef6fb6dd83e467dba0a7bd84acf60f6.jpg" alt=" ">
          <div class="card-body">
            <h6 style = "color:black;"><del>35,000 {{__('tg')}}</del></h6>
                            <h6 style = "color:#cc7894;">29,990 {{__('tg')}}</h6>
                            <h6> {{__('Lemon Raspberry')}}</h6>
                            <h6>{{__('Oreo')}}</h6>
                            <h6>{{__('Tuxedo (marble)')}}</h6>
          </div>
        ...
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src = "https://www.brides.com/thmb/OAY-pvsY0qBPFrwfLjjlxijtqpI=/1425x0/filters:no_upscale():max_bytes(200000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__brides__proteus__595d4b0d899f525cc97d971c__11-081ce1d7e3964742ab7d7b1e52830989.jpeg"  alt=" ">
          <div class="card-body">
            <h6 style = "color:black;"><del>40,000 {{__('tg')}}</del></h6>
                            <h6 style = "color:#cc7894;">34,990 {{__('tg')}}</h6>
                            <h6>{{__('Apple')}}</h6>
                            <h6>{{__('Strawberry Shortcake')}}</h6>
                            <h6>{{__('Strawberry Rhubarb')}}</h6>
          </div>
        </div>
        
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src="https://www.brides.com/thmb/eY0lnEtso6s69QHaQeflfMACx9A=/1200x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__brides__public__brides-services__production__2019__04__01__5ca2515d3e48052ef255d420_christina-and-john-wedding28-90262eb6441d47beb4885500cae40397.jpg" alt=" ">
          <div class="card-body">
           <h6 style = "color:black;"><del>45,000 {{__('tg')}}</del></h6>
                            <h6 style = "color:#cc7894;">39,990 {{__('tg')}}</h6>
                            <h6>{{__('Cherry')}}</h6>
                            <h6>{{__('Chocolate')}}</h6>
                            <h6>{{__('Coconut')}}</h6>
          </div>
        ...
        <div class="c" style="width: 23em; height:38rem;">
          <img class="cit" src="https://www.brides.com/thmb/MwsBkM3FjNKrJHUeYrt82ThiQhQ=/1200x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__brides__public__brides-services__production__2017__10__24__59ef4fc3bb23604e84f0a015_isatu-funna-and-philipp-von-hammerstein-wedding20171003_25-aa39661ac10d45b5a8c4b92d636110b0.jpg" alt=" ">
          <div class="card-body">
             <h6 style = "color:black;"><del>50,000 {{__('tg')}}</del></h6>
                            <h6 style = "color:#cc7894;">44,990 {{__('tg')}}</h6>
                            <h6>{{__('Salted Caramel')}}</h6>
                            <h6>{{__('Strawberry Shortcake')}}</h6>
                            <h6>{{__('Turtle')}}</h6>
          </div>
        </div>
