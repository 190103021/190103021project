...
<li id="contact1" style = "display:block;"  ><a style = "color:white;" href="{{route('order')}}">{{__('ORDER NOW')}}</a></li>
 ...
 <div id = "bas" style = "margin-top: -15px;">
        <div class = " headers " style = "height: 57px; min-width:1300px; margin-left: 80px;">
            <div class="log" onclick="window.location.reload()"><a href="{{route('home')}}"></a></div>
        ...
        <div class = "bg1" style="height:200px;">
            <h3 id = "gggg">{{__('Birthday cakes')}}</h3>
        </div>

        <div id="us2">
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src = "https://copenhagenbakery.com/rosegold18/?v=f24485ae434a"  alt=" ">
          <div class="card-body">
        ...
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src="https://copenhagenbakery.com/wp-content/uploads/2018/08/copenhagen-bakery-adult-birthday-birds.jpg" alt=" ">
          <div class="card-body">
        ...
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src="https://copenhagenbakery.com/copenhagen-bakery-adult-birthday-painter/?v=f24485ae434a" alt=" ">
          <div class="card-body">
        ...
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src = "https://copenhagenbakery.com/copenhagen-bakery-adult-birthday-tropical-island-tiki/?v=f24485ae434a"  alt=" ">
          <div class="card-body">
        ...
        <div class="c" style="width: 23rem; height:38rem;">
          <img class="cit" src="https://copenhagenbakery.com/copenhagen-bakery-adult-birthday-black-gold-drip/?v=f24485ae434a" alt=" ">
          <div class="card-body">
        ...
        <div class="c" style="width: 23em; height:38rem;">
          <img class="cit" src="https://copenhagenbakery.com/copenhagen-bakery-adult-birthday-floral-18/?v=f24485ae434a" alt=" ">
          <div class="card-body">
